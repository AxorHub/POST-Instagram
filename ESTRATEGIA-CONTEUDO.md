...
## 2. Tabela de temas dos concorrentes

| # | Concorrente | Ameaça | Tema/dor explorada | Conteúdo provável |
|---|-------------|--------|--------------------|-------------------|
| 1 | High Torque | 9,4 — Muito alta | Processo técnico + transparência (342 avaliações) | Reels de bastidor, checklist em vídeo, entrega técnica |
| 2 | Divas Car | 9,1 — Muito alta | Nicho feminino: respeito, explicação, "sem enrolação" (264 avaliações) | Posts didáticos, atendimento humanizado |
| 3 | Maia Car | 8,8 — Alta | Confiança + presença multicanal (YT/TikTok/IG, 12x) | Conteúdo SEO/educativo curto |
| 4 | Maranata Pneus | 8,4 — Alta | Volume + serviços recorrentes (+180 carros/mês) | Campanhas sazonais, alta frequência |
| 5 | Neto Diagnósticos | 8,1 — Alta | "Gastei no mecânico e não resolveu" (+98% satisfação) | Casos de falhas difíceis, leitura de códigos |
| 6 | Oficina My Car | 7,7 — Média-alta | Rapidez + tecnologia (DTCs, alinhamento 3D) | Reels técnicos de diagnóstico |
| 7 | Car Plus | 7,2 — Média | Prova social + localização (4,8★, 282 avaliações) | Depoimentos, conteúdo de bairro |
| 8 | M8 Retífica | 6,9 — Média | Premium + motor/retífica (garantia, 6x) | Reparos complexos |

---

## 3. Tabela de oportunidades para a MM AutoTech
...
## 5. 20 ideias de posts

| # | Pilar | Tema | Formato |
|---|-------|------|---------|
| 1 | 3 | Luz da injeção acesa: o que fazer | Reel |
...
| 9 | 3 | Superaquecimento do motor | Carrossel |
| 10 | 5 | Revisão antes de viagem | Post oferta |
| 11 | 5 | Troca de óleo no prazo certo | Story |
| 12 | 1 | Scanner automotivo: para que serve | Reel |
...
| 20 | 2 | Por que não escolher oficina só pelo preço | Carrossel |

---

## 6. 10 roteiros curtos para Reels

Estrutura: Gancho (0–3s) → Problema → Prova/processo → CTA.
...
9. **Revisão de viagem:** mala no porta-malas → checklist → "10 min evitam dor de cabeça" → CTA.
10. **Superaquecimento:** ponteiro no vermelho → "termostática, bomba, radiador?" → "rodar quente funde motor" → CTA.

---

## 7. 10 ideias de Stories

1. Enquete: "Quanto tempo desde sua última troca de óleo?"
2. Caixinha: "Manda o barulho do seu carro que eu dou o palpite técnico."
3. Bastidor cru: scanner sendo conectado + sticker "agende".
4. Antes/depois com slider (peça suja → nova).
5. Print de avaliação Google + "Obrigado, [nome]!" + link WhatsApp.
6. Contagem regressiva para campanha de AC antes do verão.
7. Quiz: "Essa luz no painel significa o quê?"
8. Depoimento em vídeo de cliente.
...
5. **Câmbio automático: 5 sinais de que algo está errado.**
...
|-----|-------|----------|---------|
| 1 | 1 | Luz da injeção: o que fazer | Reel |
...
| 9 | 3 | Carro falhando: causas | Reel |
| 10 | 1 | O que o scanner lê | Carrossel |
| 11 | 4 | Caixinha de perguntas | Story |
| 12 | 3 | Barulho na suspensão | Carrossel |
| 13 | 5 | Check-up preventivo | Post oferta |
| 14 | 4 | Bastidores "um dia na MM" | Story |
| 15 | 5 | Caso resolvido: defeito que ninguém achava | Reel |
| 16 | 3 | Freio fazendo ruído | Reel |
| 17 | 2 | Orçamento claro antes do serviço | Post estático |
| 18 | 1 | Quiz "essa luz significa?" | Story |
| 19 | 3 | Superaquecimento do motor | Carrossel |
| 20 | 5 | Revisão antes de viagem | Post oferta |
| 21 | 4 | Antes/depois (slider) | Story |
| 22 | 1 | Scanner: para que serve | Reel |
...
| 30 | 5 | Diagnóstico pelo WhatsApp (fechamento) | Post oferta |

Distribuição: Pilar 1 ×6 · Pilar 2 ×4 · Pilar 3 ×9 · Pilar 4 ×6 · Pilar 5 ×5.

---

## 10. CTAs prontos para WhatsApp

1. "Chame no WhatsApp e agende seu diagnóstico."
2. "Seu carro deu esse sintoma? Fale com a MM AutoTech."
3. "Agende uma avaliação antes que o problema fique mais caro."
...
- Volume comoditizado da Maranata.
- Promessas de "resolve tudo" sem prova.
- Artes bonitas sem prova de processo técnico.
- Frases motivacionais / conteúdo só de preço / linguagem copiada dos concorrentes.

**Direção criativa:** preto + branco + vermelho · estilo automotivo · fotos reais · close em peças e scanner · antes/depois · mecânico explicando · print de avaliações · botão visual de WhatsApp · texto curto e forte.
