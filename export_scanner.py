...
INPUT_HTML=Path("carousel_scanner.html"); OUTPUT_DIR=Path("slides_scanner"); OUTPUT_DIR.mkdir(exist_ok=True)
TOTAL_SLIDES=8; VIEW_W,VIEW_H=420,525; SCALE=1080/420
async def run():
